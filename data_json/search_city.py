...
def search_citys(response_text: str) -> Dict:
    """
    Получаем ответ от сервера с возможными вариантами городов.
    Возвращает словарь с названиями городов и их идентификатором.
